...
C_SRCS += \
../user_events/events.c 

OBJS += \
./user_events/events.o 

C_DEPS += \
./user_events/events.d 


# Each subdirectory must supply rules for building sources it contributes
user_events/%.o user_events/%.su user_events/%.cyclo: ../user_events/%.c user_events/subdir.mk
...
clean: clean-user_events

clean-user_events:
	-$(RM) ./user_events/events.cyclo ./user_events/events.d ./user_events/events.o ./user_events/events.su

.PHONY: clean-user_events
